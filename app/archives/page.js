...
export default function Fullscreenarchives({ onClose }) {
  const [currentPhotoIndex, setCurrentPhotoIndex] = useState(0);
  const scrollContainerRef = useRef(null);

  const photos = [
    { id: 1, src: "/archives/1.jpg" },
    { id: 2, src: "/archives/2.jpg" },
    { id: 3, src: "/archives/3.jpg" },
    { id: 4, src: "/archives/4.jpg" },
    { id: 5, src: "/archives/5.jpg" },
    { id: 6, src: "/archives/6.jpg" },
    { id: 7, src: "/archives/7.jpg" },    
    { id: 8, src: "/archives/8.jpg" },    
    { id: 9, src: "/archives/9.jpg" },
    ...
    <div className="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center z-50">
      <div className="w-full h-full max-w-4xl flex flex-col mx-auto rounded-xl shadow-2xl">
        ...
        <div className="bg-black text-center p-5">
          <h2 className="text-4xl font-mono text-white tracking-wider">archives</h2>
        </div>
